...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    title: 'Rahul B. Kavale & Co.: Corporate Web Presence & Client Portal',
    client: 'Rahul B. Kavale & Co.',
    location: 'Maharashtra, India',
    category: 'Corporate Web Development & Client Portal',
    industry: 'Corporate',
    service: 'Web',
  ...
  {
    slug: 'yashodeep-agro',
    title: 'Yashodeep Agro: Agri-Tech Web Platform & Operations Digitization',
    client: 'Yashodeep Agro',
    location: 'Maharashtra, India',
    category: 'Agri-Tech Web Platform',
    industry: 'Agri-Tech',
    service: 'Web',
  ...
  {
    slug: 'dairy-flow-pro',
    title: 'Dairy Flow Pro: Enterprise Dairy ERP & Automated Billing SaaS',
  ...
  },
  {
    ...
    title: 'Karyala Jodo: Political Tech & Grassroots Mobilization Portal',
    client: 'Santosh Phadtare (Political Portal)',
    location: 'Maharashtra, India',
    category: 'Political Tech & Grassroots Mobilization',
  ...
  },
  {
    ...
    title: 'Trust Carry Logistics: Fleet Showcase & Supply Chain Tracking',
    client: 'Trust Carry Logistics',
    location: 'Navi Mumbai / Pune, India',
    category: 'Logistics & Supply Chain Web Platform',
    industry: 'Logistics',
    service: 'Web',
  ...
  },
  {
    ...
    title: 'Sangola Vikas Sankalp: Campaign Portal & Civic Development Tracker',
    client: 'Shivsena Sangola',
  ...
  },
  {
    ...
    title: 'Prasaraka (Payal & Amit): Political Personal Branding & Spokesperson Portal',
